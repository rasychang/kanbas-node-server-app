const assignment = {      // object state persists as long as server is running
    id: 1,
    title: "NodeJS Assignment",   // changes to the object persist rebooting server resets the object
...
const Lab5 = (app) => {   // accept app reference to express module
    ...
    app.get("/a5/assignment", (req, res) => {   // use .json() instead of .send() if you know the response is formatted as JSON
        res.json(assignment);
      });
